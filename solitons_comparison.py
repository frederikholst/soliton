...
## PART 3: We now double the grid size by a factor of 2 and 4 respectively to check for convergence. 
...
## PART 3: Quantify the goodness of the solver
...
for t in T_series[1:]:  # Skip the initial time step (t=0)
    ...
    analytical = np.array([soliton_solution(x, t) for x in x_series4])
